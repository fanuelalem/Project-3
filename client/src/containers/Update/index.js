...
<Helmet>
   <style>{'body { background-color:#532f8c;  }'}</style>
         ...
         <div style={{margin:'80px 20px 0px 20px',backgroundColor:"whitesmoke",minHeight:"80vh"}}>
...
<button className='axiosRequestImages' onClick={handleRequest}> axios request</button>
</form>
